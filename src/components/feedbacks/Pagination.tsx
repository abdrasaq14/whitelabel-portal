    ...
    return (
        <div style={{ display: 'flex', gap: '8px', justifyContent: 'center', alignItems: 'center', padding: '10px' }}>
            ...
            <div className='flex w-[100px]'>
                ...
                <AppButton handleClick={() => onPageChange(page - 1)} type={page === 1 ? ButtonType.DISABLED : ButtonType.SECONDARY} text="Previous" />

            </div>

            {pageNumbers.map((pageNumber) => (
                
                <div className="w-[50px]" key={pageNumber}>
                
                    <AppButton
                        key={pageNumber}
                        handleClick={() => handlePageClick(pageNumber)}
                        type={page === pageNumber ? ButtonType.PRIMARY : ButtonType.SECONDARY}
