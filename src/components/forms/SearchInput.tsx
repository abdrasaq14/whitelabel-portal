import { ISearch } from "@/interfaces/ComponentInterfaces";
...
const SearchInput = ({
  ...
  return (
    <div className="h-10 hidden relative border-[#52198baf]  bg-white px-3 border shadow-sm rounded-md md:w-full md:flex items-center">
      {value && (
        <img
          src="/icons/close.svg"
      ...
      <div className="flex flex-1 h-full items-center">
        <img src="/icons/search.svg" className="w-5 mr-1" alt="" />
        <input
          onChange={onChange}
