...
export default function ColorPicker({ setColor, theme }: any) {
  const [primaryCode, setPrimaryCode] = useState<string>(
    theme ? theme.primaryColor.slice(1).toUpperCase() : "#000000"
  );
  const [secondaryCode, setSecondaryCode] = useState<string>(
    theme ? theme.secondaryColor.slice(1).toUpperCase() : "#0344a2"
  );
  const [footerCode, setFooterCode] = useState<string>(
    theme ? theme.footerColor.slice(1).toUpperCase() : "#000000"
  );
          ...
          <div className="flex flex-col mt-3">
            ...
            <div className="bg-[#F1F0F0] p-2 mt-2 flex justify-between items-center">
              <div className="flex items-center">
                ...
                />
                <span className="text-[#000000] font-satoshiMedium leading-5 tracking-tighter text-[14px]">
                  {primaryCode}
                </span>
              </div>
              <span className="text-[#000000] font-satoshiRegular leading-4 tracking-tighter text-[12px]">
                100%
              </span>
            </div>
          </div>
          <div className="flex flex-col mt-3">
            ...
            <div className="bg-[#F1F0F0] p-2 mt-2 flex justify-between items-center">
              <div className="flex items-center">
                ...
                <input
                  type="color"
                  value={theme && theme.secondaryColor}
                  className="h-[20px] w-[20px] mr-3"
                  onChange={(e) => {
