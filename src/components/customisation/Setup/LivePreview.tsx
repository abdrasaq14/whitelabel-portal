  ...
  return (
    <>
      <div className="bg-primary col-start-3 col-end-6 p-5">
        <p className="text-[#FFFFFF] text-[18px] tracking-tighter leading-6 font-satoshiBold">
          Live Preview
        </p>
        ...
        <div className="w-full mt-10">
          {stage === 1 && (
            <div
              className="flex p-2 w-full bg-[#380062] items-center"
...

          {
            stage === 1 && (
              <BannerTemplate
                ...
                heroImage={data.banner.imageUrl}
                heroText={data.banner.text}
                template={
                  data.banner.tempate === "Template 3"
                    ? 2
                    : data.banner.tempate === "Template 2"
                    ? 1
                    : 0
                }
              />
          ...
          {stage === 2 && (
            <div className="bg-[#ffffff] pt-10 px-10">
              <div
                className="text-center text-[18px] font-satoshi"
                style={{ color: primaryColor }}
              >
                About Us
              </div>
              <div className="text-[12px] text-center mt-5 w-full border text-balance">
                {shortText}
              </div>

              <div className="mt-10 grid grid-cols-4 gap-5">
                <div
                  className="flex items-center justify-around p-2 border rounded-md"
                  style={{ borderColor: primaryColor }}
                >
                  <img src="/images/lock.svg" />
                  <span
                    className="font-satoshiRegular text-[#006600] text-[12px]"
                    style={{ color: primaryColor }}
                  >
                    Secure Payment
                  </span>
                ...
                >
                  ...
                  <span
                    className="font-satoshiRegular text-[12px]"
                    style={{ color: primaryColor }}
                  >
                    100% Guarantee
                  </span>
          ...
          {stage === 2 && (
            <div className="bg-[#ffffff] pt-5">
              <p
                style={{ backgroundColor: primaryColor }}
                className="h-[40px] w-full font-satoshiMedium text-[12px] flex justify-center items-center text-[#ffffff] mt-10"
              >
                Back to top
              </p>
            </div>
          ...
          <div
            className="p-10 grid grid-cols-2"
            style={{ backgroundColor: footerColor }}
          >
            <div className="flex flex-col">
              <img src={logo} style={{ maxWidth: 100 }} />
              <p className="font-satoshiMedium mt-5 text-[14px] text-[#ffffff] leading-2 tracking-tight">
                New to Landmark
              </p>
              <p className="font-satoshiRegular text-[12px] text-[#ffffff] leading-2 tracking-tight">
                Subscribe to our newsletter to get updates on our new offers
              </p>
              <div className="flex mt-3">
                <div className="w-[70%] bg-[#ffffff] h-[30px] rounded-l-md text-[12px] px-5 flex items-center font-satoshiMedium">
                  Enter your email address
                </div>
                <div
                  className="w-[30%] h-[30px] rounded-r-md text-[12px] text-[white] font-satoshiRegular flex justify-center items-center"
                  style={{ backgroundColor: primaryColor }}
                >
                  Subscribe
                </div>
            ...
            <div className="flex flex-col items-end">
              <p className="text-[#ffffff] font-satoshiMedium text-[14px]">
                Company
              </p>
              <p className="text-[#ffffff] font-satoshiRegular text-[12px]">
                About Us
              </p>
              <p className="text-[#ffffff] font-satoshiRegular text-[12px]">
              ...
              <p className="text-[#ffffff] font-satoshiMedium text-[14px] mt-5">
                Help Center
              </p>
              <p className="text-[#ffffff] font-satoshiRegular text-[12px]">
                Contact Us
              ...
              <div className="flex mt-5 gap-3 items-center">
                <span className="text-[#ffffff] font-satoshiRegular text-[12px]">
                  JOIN US ON
                </span>
