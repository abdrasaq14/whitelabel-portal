    ...
    return (
        <div className="flex flex-col mt-10">
            <h4 className="text-[#2B2C34] font-satoshiBold text-[36px] leading-10 tracking-tighter">Customise your
                Account</h4>
            {stage === 0 && <h6 className="mt-3 text-[#2B2C34] font-satoshiMedium text-[24px] leading-8 tracking-tighter">Let's get
                started!</h6>}
            <div className="flex justify-between items-center">
                ...
                <span className="text-primary text-14px cursor-pointer" onClick={prev}>Prev</span>
            </div>
