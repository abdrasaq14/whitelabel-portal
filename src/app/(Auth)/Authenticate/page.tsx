...
const page = () => {
  return (
    <div className='flex mt-16 w-screen justify-center items-center'>

      <div className='bg-white my-8 sm:border-[0.4px] sm:border-purple-main rounded-lg sm:w-[464px] py-8 px-9 sm:shadow-custom max-h-[624px]'>
