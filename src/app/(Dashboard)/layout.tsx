...
const navItems: SideNavItem[] = [
    ...
    { label: 'Product', href: 'product', icon: ProductIcon, children: [{label: 'All Products', href: '/product/all-products'}, {label: 'Blocked Product', href: '/product/blocked-products'}, {label: 'Product Request', href: '/product/request'}] },
