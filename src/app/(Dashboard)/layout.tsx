...
const navItems: SideNavItem[] = [
    ...
    { label: 'Product', href: 'product', icon: ProductIcon, children: [{label: 'All Products', href: '/product/all'}, {label: 'Blocked Product', href: '/product/blocked'}, {label: 'Product Request', href: '/product/request'}] },
